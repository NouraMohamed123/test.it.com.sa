...
<div class="side-content-wrap">
    ...
    auth()->user()->can('employee_add'))
                <li class="nav-item {{ request()->is('jops') || request()->is('jops/*') ? 'active' : '' }}"
                    data-item="jops">
                    <a class="nav-item-hold" href="#">
                        <i class="nav-icon i-Engineering"></i>
                        <span class="nav-text">{{ __('translate.jops') }}</span>
                    </a>
                    <div class="triangle"></div>
                </li>
            @endif
    ...
    auth()->user()->can('training_skills'))
                <li class="nav-item {{ request()->is('trainings') || request()->is('trainers') || request()->is('training_skills') ? 'active' : '' }}"
                    data-item="training">
                    <a class="nav-item-hold" href="{{ route('trainings.index') }}">
    ...
    <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        ...
        <ul class="childNav" data-parent="jops">
            @can('employee_add')
                <li class="nav-item">
                    <a class="{{ Route::currentRouteName() == 'jops' ? 'open' : '' }}"
                        href="{{ route('jops.index') }}">
                        <i class="nav-icon i-Add-User"></i>
                        <span class="item-name">{{ __('translate.jops_List') }}</span>
                    </a>
                </li>
            @endcan
            @can('employee_view')
                <li class="nav-item">
                    <a href="{{ route('candidates.index') }}"
                        class="{{ Route::currentRouteName() == 'candidates.index' ? 'open' : '' }}">
                        <i class="nav-icon i-Business-Mens"></i>
                        <span class="item-name">{{ __('translate.candidates_List') }}</span>
                    </a>
                </li>
            @endcan
