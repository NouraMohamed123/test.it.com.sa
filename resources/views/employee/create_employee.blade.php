...
<script>
    ...
    data: {
        ...
        employee: {
            ...
            supervisor_name: "",                
            social_enterprises_date: "",        

            contract_expiry_date: "",           

            medical_insurance_joining: "",      
            medical_insurance_expiry: "",       

            platform_contract_joining: "",      
            platform_contract_expiry: "",       
        ...
        Create_Employee() {
            ...
            if (!self.data || !(self.data instanceof FormData)) {
                self.data = new FormData();
                 ...
                 self.data.append("firstname", self.employee.firstname);
                 self.data.append("lastname", self.employee.lastname);
                 self.data.append("country", self.employee.country);
                 self.data.append("email", self.employee.email);
                 self.data.append("gender", self.employee.gender);
                 self.data.append("phone", self.employee.phone);
                 self.data.append("birth_date", self.employee.birth_date);
                 self.data.append("company_id", self.employee.company_id);
                 self.data.append("department_id", self.employee.department_id);
                 self.data.append("designation_id", self.employee.designation_id);
                 self.data.append("office_shift_id", self.employee.office_shift_id);
                 self.data.append("joining_date", self.employee.joining_date);
                 self.data.append("password", self.employee.password);
                 self.data.append("password_confirmation", self.employee.password_confirmation);
                 self.data.append("role_users_id", self.employee.role_users_id);
                 self.data.append("third_name", self.employee.third_name);
                 self.data.append("fourth_name", self.employee.fourth_name);
                 self.data.append("start_trial_date", self.employee.start_trial_date);
                 self.data.append("end_trial_date", self.employee.end_trial_date);
                 self.data.append("job_description", self.employee.job_description);
                 self.data.append("language_level", self.employee.language_level);
                 self.data.append("specialization", self.employee.specialization);
                 self.data.append("educational_qualification", self.employee.educational_qualification);
                 self.data.append("supervisor_name", self.employee.supervisor_name);
                 self.data.append("social_enterprises_date", self.employee.social_enterprises_date);
                 self.data.append("contract_expiry_date", self.employee.contract_expiry_date);
                 self.data.append("medical_insurance_joining", self.employee.medical_insurance_joining);
                 self.data.append("medical_insurance_expiry", self.employee.medical_insurance_expiry);
                 self.data.append("platform_contract_joining", self.employee.platform_contract_joining);
                 self.data.append("platform_contract_expiry", self.employee.platform_contract_expiry);
                 self.data.append("date_of_birth_hijri", self.employee.date_of_birth_hijri);
                 self.data.append("weekend_days", self.employee.weekend_days);
                 self.data.append("annual_leave_days", self.employee.annual_leave_days);
                 self.data.append("monthly_working_days", self.employee.monthly_working_days);
                 self.data.append("required_to_attend", self.employee.required_to_attend);
                 self.data.append("marital_status", self.employee.marital_status);
                 self.data.append("has_special_needs", self.employee.has_special_needs);
                 self.data.append("disability_type", self.employee.disability_type);
                 self.data.append("scene_image", self.employee.scene_image);
                 self.data.append("job_type", self.employee.job_type);
                 self.data.append("contract_type", self.employee.contract_type);
                 self.data.append("job_title", self.employee.job_title);
                 self.data.append("avatar", self.employee.avatar);


            axios.post("/employees", self.data).then(response => {
