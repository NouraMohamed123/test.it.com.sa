...
if ($installed === true) {
    ...
    Route::group(['middleware'=>'XSS'],function(){
        ...
        Route::group(['middleware'=>'auth'],function(){
            ...
            //------------------------------- jops --------------------------\\
            Route::resource('jops', 'JopsController');
            Route::post("jops/delete/by_selection", "JopsController@delete_by_selection");
            //--------------------------------------------------------------------\\
            //------------------------------- candidates --------------------------\\
            Route::resource('candidates', 'CandidateController');
            Route::post("candidates/delete/by_selection", "CandidateController@delete_by_selection");
